$(document).ready(function () {
    ...
    $("#drplanguage").change(function () {
        ...
        window.location.href = "/yonetim/urunaltgruplari/" + lang;
    });

    $("#drpgroupforsub").change(function () {
        var lang = $("#drplanguage option:selected").val();
        id = $("#drpgroupforsub option:selected").val();
        window.location.href = "/yonetim/urunaltgruplari/" + lang + "/" + id;
    });
...
function UpdateRecord(id) {
    ...
    $.ajax({
        type: 'POST',
        url: '/ProductSubGroup/UpdateRecord',
